(defproject suhimadcat "0.1.0-SNAPSHOT"
  ...
  :ring {:handler suhimadcat.handler/app
         :nrepl {:start? true
                 :port 9998}}
  ...
  :cljsbuild {:builds
              [{:id "dev"
                ...
                ;; into your build
                :figwheel {:on-jsload "suhimadcat.core/on-js-reload"
                ...
                :compiler {:main suhimadcat.core
                           :asset-path "js/compiled/out"
                           :output-to "resources/public/js/compiled/suhimadcat.js"
