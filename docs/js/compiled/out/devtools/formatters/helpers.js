...
var G__40239 = devtools.prefs.pref.call(null,v);
v = G__40239;
continue;
} else {
return v;
...
var and__26358__auto__ = cljs.core.not.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"disable-cljs-fn-formatting","disable-cljs-fn-formatting",1903786837)));
if(and__26358__auto__){
var and__26358__auto____$1 = !(cljs.core.var_QMARK_.call(null,value));
...
var or__26370__auto__ = (function (){try{if(!((value == null))){
...
}catch (e40252){var e__37638__auto__ = e40252;
return false;
}})();
if(cljs.core.truth_(or__26370__auto__)){
return or__26370__auto__;
} else {
var or__26370__auto____$1 = (function (){try{if(!((value == null))){
...
}catch (e40256){var e__37638__auto__ = e40256;
return false;
}})();
...
}catch (e40258){var e__37638__auto__ = e40258;
return false;
}}
}
});
devtools.formatters.helpers.cljs_type_QMARK_ = (function devtools$formatters$helpers$cljs_type_QMARK_(f){
var and__26358__auto__ = goog.isObject(f);
if(cljs.core.truth_(and__26358__auto__)){
var and__26358__auto____$1 = cljs.core.not.call(null,devtools.formatters.helpers.is_prototype_QMARK_.call(null,f));
if(and__26358__auto____$1){
...
var and__26358__auto__ = goog.isObject(value);
if(cljs.core.truth_(and__26358__auto__)){
...
var or__26370__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(or__26370__auto__)){
return or__26370__auto__;
} else {
...
var and__26358__auto__ = (function (){var or__26370__auto__ = devtools.formatters.helpers.cljs_land_value_QMARK_.call(null,value);
if(cljs.core.truth_(or__26370__auto__)){
return or__26370__auto__;
} else {
...
var vec__40263 = devtools.munging.parse_constructor_info.call(null,constructor_fn);
var ns = cljs.core.nth.call(null,vec__40263,(0),null);
var name = cljs.core.nth.call(null,vec__40263,(1),null);
...
var and__26358__auto__ = devtools.formatters.helpers.cljs_instance_QMARK_.call(null,value);
if(cljs.core.truth_(and__26358__auto__)){
...
var or__26370__auto__ = typeof value === 'string';
if(or__26370__auto__){
return or__26370__auto__;
} else {
var or__26370__auto____$1 = typeof value === 'number';
...
return cljs.core.some.call(null,(function (p1__40266_SHARP_){
return cljs.core._EQ_.call(null,devtools.formatters.helpers.pref.call(null,new cljs.core.Keyword(null,"more-marker","more-marker",-14717935)),p1__40266_SHARP_);
}),template);
});
...
//# sourceMappingURL=helpers.js.map?rel=1492960143330