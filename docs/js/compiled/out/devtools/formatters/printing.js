...
var len__27483__auto___40282 = arguments.length;
var i__27484__auto___40283 = (0);
while(true){
if((i__27484__auto___40283 < len__27483__auto___40282)){
args__27490__auto__.push((arguments[i__27484__auto___40283]));

var G__40284 = (i__27484__auto___40283 + (1));
i__27484__auto___40283 = G__40284;
continue;
} else {
}
break;
...
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),(arguments[(1)]),argseq__27491__auto__);
});
...
devtools.formatters.printing.build_markup.cljs$lang$applyTo = (function (seq40279){
var G__40280 = cljs.core.first.call(null,seq40279);
var seq40279__$1 = cljs.core.next.call(null,seq40279);
var G__40281 = cljs.core.first.call(null,seq40279__$1);
var seq40279__$2 = cljs.core.next.call(null,seq40279__$1);
return devtools.formatters.printing.build_markup.cljs$core$IFn$_invoke$arity$variadic(G__40280,G__40281,seq40279__$2);
});
...
if(cljs.core.truth_((function (){var or__26370__auto__ = devtools.formatters.helpers.directly_printable_QMARK_.call(null,value);
...
devtools.formatters.printing.TemplateWriter.cljs$lang$ctorPrWriter = (function (this__26981__auto__,writer__26982__auto__,opt__26983__auto__){
return cljs.core._write.call(null,writer__26982__auto__,"devtools.formatters.printing/TemplateWriter");
});
...
if(cljs.core.truth_((function (){var and__26358__auto__ = cljs.core.not.call(null,devtools.formatters.printing.already_reference_QMARK_.call(null,group));
if(and__26358__auto__){
var or__26370__auto__ = devtools.formatters.helpers.expandable_QMARK_.call(null,obj);
if(cljs.core.truth_(or__26370__auto__)){
return or__26370__auto__;
} else {
...
if(cljs.core.truth_(devtools.formatters.helpers.should_render_QMARK_.call(null,new cljs.core.Keyword(null,"render-metas","render-metas",1141294116),value,(function (p1__40285_SHARP_){
return !((cljs.core.meta.call(null,p1__40285_SHARP_) == null));
})))){
...
var markup_db = cljs.core.get.call(null,map__40294__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
if(cljs.core.truth_((function (){var or__26370__auto__ = (function (){try{if(!((obj == null))){
...
}catch (e40298){var e__37638__auto__ = e40298;
return false;
}})();
if(cljs.core.truth_(or__26370__auto__)){
return or__26370__auto__;
...
}catch (e40300){var e__37638__auto__ = e40300;
return false;
}}
})())){
...
var _STAR_current_state_STAR_40305 = devtools.formatters.state._STAR_current_state_STAR_;
devtools.formatters.state._STAR_current_state_STAR_ = devtools.formatters.state.get_current_state.call(null);

try{var map__40306 = opts;
...
var markup_db = cljs.core.get.call(null,map__40306__$1,new cljs.core.Keyword(null,"markup-db","markup-db",812838734));
...
}finally {devtools.formatters.state._STAR_current_state_STAR_ = _STAR_current_state_STAR_40305;
}});
...
;
var temp__4655__auto___40311 = devtools.formatters.state.get_managed_print_level.call(null);
if(cljs.core.truth_(temp__4655__auto___40311)){
var managed_print_level_40312 = temp__4655__auto___40311;
var _STAR_print_level_STAR_40310_40313 = cljs.core._STAR_print_level_STAR_;
cljs.core._STAR_print_level_STAR_ = managed_print_level_40312;

try{devtools.formatters.state.update_current_state_BANG_.call(null,((function (_STAR_print_level_STAR_40310_40313,managed_print_level_40312,temp__4655__auto___40311,writer,opts,job_fn){
return (function (p1__40308_SHARP_){
return devtools.formatters.state.set_managed_print_level.call(null,p1__40308_SHARP_,null);
});})(_STAR_print_level_STAR_40310_40313,managed_print_level_40312,temp__4655__auto___40311,writer,opts,job_fn))
);

job_fn.call(null);
}finally {cljs.core._STAR_print_level_STAR_ = _STAR_print_level_STAR_40310_40313;
}} else {
job_fn.call(null);
}
...
//# sourceMappingURL=printing.js.map?rel=1492960143487