...
var len__27483__auto___40273 = arguments.length;
var i__27484__auto___40274 = (0);
while(true){
if((i__27484__auto___40274 < len__27483__auto___40273)){
args__27490__auto__.push((arguments[i__27484__auto___40274]));

var G__40275 = (i__27484__auto___40274 + (1));
i__27484__auto___40274 = G__40275;
continue;
} else {
}
break;
...
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27491__auto__);
});
...
devtools.formatters.state.update_current_state_BANG_.cljs$lang$applyTo = (function (seq40271){
var G__40272 = cljs.core.first.call(null,seq40271);
var seq40271__$1 = cljs.core.next.call(null,seq40271);
return devtools.formatters.state.update_current_state_BANG_.cljs$core$IFn$_invoke$arity$variadic(G__40272,seq40271__$1);
});
...
return (p1__40276_SHARP_ === object);
});})(history))
,history);
});
...
//# sourceMappingURL=state.js.map?rel=1492960143369