...
var args40764 = [];
var len__27483__auto___40770 = arguments.length;
var i__27484__auto___40771 = (0);
while(true){
if((i__27484__auto___40771 < len__27483__auto___40770)){
args40764.push((arguments[i__27484__auto___40771]));

var G__40772 = (i__27484__auto___40771 + (1));
i__27484__auto___40771 = G__40772;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args40764.length)].join('')));
...
if(typeof devtools.toolbox.t_devtools$toolbox40767 !== 'undefined'){
} else {
...
*/
devtools.toolbox.t_devtools$toolbox40767 = (function (obj,header,style,tag,meta40768){
this.obj = obj;
this.header = header;
this.style = style;
this.tag = tag;
...
devtools.toolbox.t_devtools$toolbox40767.prototype.cljs$core$IWithMeta$_with_meta$arity$2 = (function (_40769,meta40768__$1){
var self__ = this;
var _40769__$1 = this;
return (new devtools.toolbox.t_devtools$toolbox40767(self__.obj,self__.header,self__.style,self__.tag,meta40768__$1));
});

devtools.toolbox.t_devtools$toolbox40767.prototype.cljs$core$IMeta$_meta$arity$1 = (function (_40769){
var self__ = this;
var _40769__$1 = this;
return self__.meta40768;
});

devtools.toolbox.t_devtools$toolbox40767.prototype.devtools$protocols$IFormat$ = cljs.core.PROTOCOL_SENTINEL;

devtools.toolbox.t_devtools$toolbox40767.prototype.devtools$protocols$IFormat$_header$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40767.prototype.devtools$protocols$IFormat$_has_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
return true;
});

devtools.toolbox.t_devtools$toolbox40767.prototype.devtools$protocols$IFormat$_body$arity$1 = (function (_){
var self__ = this;
var ___$1 = this;
...
devtools.toolbox.t_devtools$toolbox40767.getBasis = (function (){
return new cljs.core.PersistentVector(null, 5, 5, cljs.core.PersistentVector.EMPTY_NODE, [new cljs.core.Symbol(null,"obj","obj",-1672671807,null),new cljs.core.Symbol(null,"header","header",1759972661,null),new cljs.core.Symbol(null,"style","style",1143888791,null),new cljs.core.Symbol(null,"tag","tag",350170304,null),new cljs.core.Symbol(null,"meta40768","meta40768",-108923163,null)], null);
});

devtools.toolbox.t_devtools$toolbox40767.cljs$lang$type = true;

devtools.toolbox.t_devtools$toolbox40767.cljs$lang$ctorStr = "devtools.toolbox/t_devtools$toolbox40767";

devtools.toolbox.t_devtools$toolbox40767.cljs$lang$ctorPrWriter = (function (this__26981__auto__,writer__26982__auto__,opt__26983__auto__){
return cljs.core._write.call(null,writer__26982__auto__,"devtools.toolbox/t_devtools$toolbox40767");
});

devtools.toolbox.__GT_t_devtools$toolbox40767 = (function devtools$toolbox$__GT_t_devtools$toolbox40767(obj__$1,header__$1,style__$1,tag__$1,meta40768){
return (new devtools.toolbox.t_devtools$toolbox40767(obj__$1,header__$1,style__$1,tag__$1,meta40768));
});

}

return (new devtools.toolbox.t_devtools$toolbox40767(obj,header,style,tag,cljs.core.PersistentArrayMap.EMPTY));
});
...
//# sourceMappingURL=toolbox.js.map?rel=1492960144323