...
var or__26370__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
...
return (new CustomEvent(event_name,(function (){var obj33836 = {"detail":data};
return obj33836;
})()));
} else {
...
if(cljs.core.truth_((function (){var and__26358__auto__ = figwheel.client.utils.html_env_QMARK_.call(null);
if(cljs.core.truth_(and__26358__auto__)){
var and__26358__auto____$1 = (window["CustomEvent"]);
...
var args33841 = [];
var len__27483__auto___33847 = arguments.length;
var i__27484__auto___33848 = (0);
while(true){
if((i__27484__auto___33848 < len__27483__auto___33847)){
args33841.push((arguments[i__27484__auto___33848]));

var G__33849 = (i__27484__auto___33848 + (1));
i__27484__auto___33848 = G__33849;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33841.length)].join('')));
...
var expr__33845 = (cljs.core.truth_(figwheel.client.utils.html_or_react_native_env_QMARK_.call(null))?level:new cljs.core.Keyword(null,"info","info",-317069002));
if(cljs.core.truth_(pred__33844.call(null,new cljs.core.Keyword(null,"warn","warn",-436710552),expr__33845))){
return ((function (pred__33844,expr__33845){
return (function (p1__33837_SHARP_){
return console.warn(p1__33837_SHARP_);
});
;})(pred__33844,expr__33845))
} else {
...
return console.debug(p1__33838_SHARP_);
});
;})(pred__33844,expr__33845))
} else {
...
return console.error(p1__33839_SHARP_);
});
;})(pred__33844,expr__33845))
} else {
return ((function (pred__33844,expr__33845){
return (function (p1__33840_SHARP_){
return console.log(p1__33840_SHARP_);
});
;})(pred__33844,expr__33845))
}
}
...
figwheel.client.utils.eval_helper = (function figwheel$client$utils$eval_helper(code,p__33851){
var map__33854 = p__33851;
...
var opts = map__33854__$1;
var eval_fn = cljs.core.get.call(null,map__33854__$1,new cljs.core.Keyword(null,"eval-fn","eval-fn",-1111644294));
...
return new_def.callback(p1__33856_SHARP_);
});})(new_def))
);
...
return (function (p__33857){
var vec__33858 = p__33857;
var ky = cljs.core.nth.call(null,vec__33858,(0),null);
var v = cljs.core.nth.call(null,vec__33858,(1),null);
...
var args33861 = [];
var len__27483__auto___33864 = arguments.length;
var i__27484__auto___33865 = (0);
while(true){
if((i__27484__auto___33865 < len__27483__auto___33864)){
args33861.push((arguments[i__27484__auto___33865]));

var G__33866 = (i__27484__auto___33865 + (1));
i__27484__auto___33865 = G__33866;
continue;
} else {
}
break;
...
break;
default:
throw (new Error([cljs.core.str.cljs$core$IFn$_invoke$arity$1("Invalid arity: "),cljs.core.str.cljs$core$IFn$_invoke$arity$1(args33861.length)].join('')));
...
if(cljs.core.truth_((function (){var and__26358__auto__ = typeof localStorage !== 'undefined';
...
//# sourceMappingURL=utils.js.map?rel=1492960134784