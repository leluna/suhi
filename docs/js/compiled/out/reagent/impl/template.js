...
reagent.impl.template.NativeWrapper.cljs$lang$ctorPrWriter = (function (this__26981__auto__,writer__26982__auto__,opt__26983__auto__){
return cljs.core._write.call(null,writer__26982__auto__,"reagent.impl.template/NativeWrapper");
});
...
var G__28090 = o;
(G__28090[reagent.impl.template.cached_prop_name.call(null,k)] = reagent.impl.template.convert_prop_value.call(null,v));
...
if(cljs.core.truth_((function (){var and__26358__auto__ = !((jsprops == null));
if(and__26358__auto__){
var and__26358__auto____$1 = jsprops.hasOwnProperty("onChange");
...
var G__28098 = jsprops;
(G__28098["defaultValue"] = value);

(G__28098["onChange"] = ((function (G__28098,v,value,on_change){
return (function (p1__28096_SHARP_){
return reagent.impl.template.input_handle_change.call(null,this$,on_change,p1__28096_SHARP_);
});})(G__28098,v,value,on_change))
);
...
var vec__28105 = cljs.core.next.call(null,cljs.core.re_matches.call(null,reagent.impl.template.re_tag,cljs.core.name.call(null,hiccup_tag)));
var tag = cljs.core.nth.call(null,vec__28105,(0),null);
var id = cljs.core.nth.call(null,vec__28105,(1),null);
var class$ = cljs.core.nth.call(null,vec__28105,(2),null);
...
var jsprops = ({"argv": v});
var temp__4661__auto___28110 = reagent.impl.template.key_from_vec.call(null,v);
if((temp__4661__auto___28110 == null)){
} else {
var key_28111 = temp__4661__auto___28110;
(jsprops["key"] = key_28111);
}

return (reagent.impl.util.react["createElement"])(c,jsprops);
});
reagent.impl.template.adapt_react_class = (function reagent$impl$template$adapt_react_class(c){
var G__28113 = (new reagent.impl.template.NativeWrapper());
(G__28113["name"] = c);
...
var len__27483__auto___28119 = arguments.length;
var i__27484__auto___28120 = (0);
while(true){
if((i__27484__auto___28120 < len__27483__auto___28119)){
args__27490__auto__.push((arguments[i__27484__auto___28120]));

var G__28121 = (i__27484__auto___28120 + (1));
i__27484__auto___28120 = G__28121;
continue;
} else {
}
break;
...
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic((arguments[(0)]),argseq__27491__auto__);
});
...
reagent.impl.template.hiccup_err.cljs$lang$applyTo = (function (seq28117){
var G__28118 = cljs.core.first.call(null,seq28117);
var seq28117__$1 = cljs.core.next.call(null,seq28117);
return reagent.impl.template.hiccup_err.cljs$core$IFn$_invoke$arity$variadic(G__28118,seq28117__$1);
});
...
break;
default:
var G__28125 = new cljs.core.PersistentVector(null, 2, 5, cljs.core.PersistentVector.EMPTY_NODE, [cljs.core.subs.call(null,n,(0),pos),cljs.core.assoc.call(null,v,(0),cljs.core.subs.call(null,n,(pos + (1))))], null);
v = G__28125;
continue;
...
var n__27293__auto___28128 = a.length;
var i_28129 = (0);
while(true){
if((i_28129 < n__27293__auto___28128)){
(a[i_28129] = reagent.impl.template.as_element.call(null,(a[i_28129])));
...
var a = cljs.core.into_array.call(null,s);
var n__27293__auto___28131 = a.length;
var i_28132 = (0);
while(true){
if((i_28132 < n__27293__auto___28131)){
var val_28133 = (a[i_28132]);
if((cljs.core.vector_QMARK_.call(null,val_28133)) && ((reagent.impl.template.key_from_vec.call(null,val_28133) == null))){
(o["no-key"] = true);
} else {
}

(a[i_28132] = reagent.impl.template.as_element.call(null,val_28133));

var G__28134 = (i_28132 + (1));
i_28132 = G__28134;
continue;
} else {
}
...
var ctx = ({});
var vec__28138 = reagent.ratom.check_derefs.call(null,((function (ctx){
return (function (){
return reagent.impl.template.expand_seq_dev.call(null,x,ctx);
});})(ctx))
);
var res = cljs.core.nth.call(null,vec__28138,(0),null);
var derefed = cljs.core.nth.call(null,vec__28138,(1),null);
...
var G__28142 = (cljs.core.count.call(null,argv) - first_child);
switch (G__28142) {
case (0):
...
break;
default:
return (reagent.impl.util.react["createElement"]).apply(null,cljs.core.reduce_kv.call(null,((function (G__28142){
...
//# sourceMappingURL=template.js.map?rel=1492960128038